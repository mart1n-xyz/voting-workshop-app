...
# Voting Workshop Backup Dashboard Launcher

echo "📊 Voting Workshop Backup Dashboard"
echo "===================================="
echo ""
...
# Run Streamlit on port 8502 (different from main dashboard)
streamlit run backup-dashboard.py --server.port 8502
